export class AppSettings {
  ...
  public static API_BASE= 'https://api.themoviedb.org/3/discover/';
  public static LANGUAGE= '&language=en-US';

  public static MOVIES_POPULAR_ENDPOINT= AppSettings.API_BASE+'movie'+AppSettings.API_KEY +AppSettings.LANGUAGE
  +'&sort_by=popularity.desc&include_adult=false';
  public static MOVIES_TOP_RATED_ENDPOINT= AppSettings.API_BASE+'movie'+AppSettings.API_KEY +AppSettings.LANGUAGE
   +'&sort_by=vote_average.desc&include_adult=false';
  ...
  public static TV_POPULAR= AppSettings.API_BASE+'tv/popular'+AppSettings.API_KEY +AppSettings.LANGUAGE;
  public static TV_TOP_RATED= AppSettings.API_BASE+'tv/top_rated'+AppSettings.API_KEY +AppSettings.LANGUAGE;
